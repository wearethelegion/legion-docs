...
import { IconLegion } from "./icons/custom"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.legion_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.legion_name}>
                    <IconLegion width={16} height={16} />
                  </div>
