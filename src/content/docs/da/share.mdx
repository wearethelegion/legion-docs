---
title: Deling
description: Del dine Legion-samtaler.
---

Legions delingsfunksjon lar deg lage offentlige lenker til dine Legion-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Legion:
...
Legion støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Legion manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `legion.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av legion i organisasjonen din.
