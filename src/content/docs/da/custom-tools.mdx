...
description: Opret værktøjer, som LLM kan kalde legion ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med legions [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.legion/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/legion/tools/`.
