...
Legion understøtter standard proxymiljøvariabler og brugerdefinerede certifikater til virksomhedsnetværksmiljøer.

---

## Proxy

Legion respekterer standard proxy-miljøvariabler.
...
Hvis din virksomhed bruger tilpassede CA'er til HTTPS-forbindelser, skal du konfigurere Legion til at stole på dem.
