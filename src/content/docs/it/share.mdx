---
title: Condivisione
description: Condividi le tue conversazioni Legion.
---

La funzione di condivisione di Legion ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Legion:
...
Legion supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Legion usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `legion.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare legion nella tua organizzazione.
