---
title: SDK
description: Client JS type-safe per il server legion.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di legion fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare legion in modo programmatico.
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `legion.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di legion in esecuzione, puoi creare un client per collegarti:
