...
description: Crea strumenti che l'LLM puo chiamare in legion.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di legion come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.legion/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/legion/tools/`.
