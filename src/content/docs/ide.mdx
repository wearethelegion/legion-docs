---
title: IDE
description: The Legion extension for VS Code, Cursor, and other IDEs
---

Legion integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `legion` in the terminal to get started.
...
To install Legion on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `legion` - the extension installs automatically
...
Search for **Legion** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `legion` in the integrated terminal.
