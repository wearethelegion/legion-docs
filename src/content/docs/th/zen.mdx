---
title: เซน
description: รายการโมเดลที่คัดสรรโดย Legion
---
...
Legion Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน Legion

:::note
Legion Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Legion คุณเข้าสู่ระบบ Legion Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ Legion
:::
...
Legion Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

Legion Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Legion

1. คุณลงชื่อเข้าใช้ **<a href={console}>Legion Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก Legion Zen และวางคีย์ API ของคุณ
...
| ------------------ | ------------------ | -------------------------------------------------- | --------------------------- |
| GPT 5.2            | GPT-5.2            | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex      | gpt-5.2-codex      | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1            | GPT-5.1            | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex      | gpt-5.1-codex      | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max  | gpt-5.1-codex-max  | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini | gpt-5.1-codex-mini | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5              | GPT-5              | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex        | gpt-5-codex        | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano         | gpt-5-nano         | `https://wearethelegion.com/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Sonnet 4.5  | claude-sonnet-4-5  | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4    | claude-sonnet-4    | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5   | claude-haiku-4-5   | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5   | claude-haiku-3-5   | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6    | claude-opus-4-6    | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5    | claude-opus-4-5    | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1    | claude-opus-4-1    | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3 Pro       | gemini-3-pro       | `https://wearethelegion.com/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash     | gemini-3-flash     | `https://wearethelegion.com/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| MiniMax M2.1       | minimax-m2.1       | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://wearethelegion.com/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6            | glm-4.6            | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5          | kimi-k2.5          | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Free     | kimi-k2.5-free     | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://wearethelegion.com/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model id](/docs/config/#models) ในการกำหนดค่า Legion ของคุณ
ใช้รูปแบบ `legion/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `legion/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
```
https://wearethelegion.com/zen/v1/models
```
...
- GLM 4.7 ใช้งานได้ฟรีบน Legion ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Kimi K2.5 Free พร้อมใช้งานบน Legion ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- MiniMax M2.1 Free พร้อมใช้งานบน Legion ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน Legion ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ Legion ได้เช่นกัน
