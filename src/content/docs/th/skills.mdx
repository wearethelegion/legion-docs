...
ทักษะของเจ้าหน้าที่ช่วยให้ Legion ค้นพบคำแนะนำที่ใช้ซ้ำได้จาก repo หรือโฮมไดเร็กทอรีของคุณ
...
Legion ค้นหาตำแหน่งเหล่านี้:

- การกำหนดค่าโครงการ: `.legion/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/legion/skills/<name>/SKILL.md`
...
สำหรับเส้นทางภายในโปรเจ็กต์ Legion จะเดินขึ้นมาจากไดเร็กทอรีการทำงานปัจจุบันของคุณจนกว่าจะถึงแผนผังงาน git
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.legion/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/legion/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
สร้าง `.legion/skills/git-release/SKILL.md` แบบนี้:
...
Legion แสดงรายการทักษะที่มีอยู่ในคำอธิบายเครื่องมือ `skill`
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `legion.json`:
...
**สำหรับตัวแทนในตัว** (ใน `legion.json`):
