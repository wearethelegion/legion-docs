...
Legion admite variables de entorno de proxy estándar y certificados personalizados para entornos de red empresarial.

---

## Proxy

Legion respeta las variables de entorno de proxy estándar.
...
Si su empresa utiliza CA personalizadas para conexiones HTTPS, configure Legion para confiar en ellas.
