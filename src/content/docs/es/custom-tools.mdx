...
description: Cree herramientas que LLM pueda llamar en legion.
---

Las herramientas personalizadas son funciones que usted crea y que el LLM puede llamar durante las conversaciones. Trabajan junto con las [herramientas integradas](/docs/tools) de legion como `read`, `write` y `bash`.
...
- Localmente colocándolos en el directorio `.legion/tools/` de tu proyecto.
- O de forma global, colocándolos en `~/.config/legion/tools/`.
