...
Puede definir servidores MCP en su [Legion Config](https://wearethelegion.com/docs/config/) en `mcp`. Agregue cada MCP con un nombre único. Puede referirse a ese MCP por su nombre cuando solicite el LLM.
