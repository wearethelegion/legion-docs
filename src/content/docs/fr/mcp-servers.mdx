...
Vous pouvez définir des serveurs MCP dans votre [Legion Config](https://wearethelegion.com/docs/config/) sous `mcp`. Ajoutez chaque MCP avec un nom unique. Vous pouvez faire référence à ce MCP par son nom lorsque vous demandez le LLM.
