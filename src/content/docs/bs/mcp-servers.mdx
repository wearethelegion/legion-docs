...
Možete definirati MCP servere u vašoj [Legion Config](https://wearethelegion.com/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
