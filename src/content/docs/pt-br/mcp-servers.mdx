...
Você pode definir servidores MCP em sua [Configuração do legion](https://wearethelegion.com/docs/config/) sob `mcp`. Adicione cada MCP com um nome único. Você pode se referir a esse MCP pelo nome ao solicitar ao LLM.
