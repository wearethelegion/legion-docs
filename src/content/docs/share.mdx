---
title: Share
description: Share your Legion conversations.
---

Legion's share feature allows you to create public links to your Legion conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Legion:
...
Legion supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Legion uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `legion.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using legion in your organization.
