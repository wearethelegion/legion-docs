...
legion, kurumsal ağ ortamları için standart proxy ortam değişkenlerini ve özel sertifikaları destekler.

---

## Vekil Sunucu

legion respects standard proxy environment variables.
...
Kuruluşunuz HTTPS bağlantıları için özel CA'lar kullanıyorsa, legion'u bunlara güvenecek şekilde yapılandırın.
