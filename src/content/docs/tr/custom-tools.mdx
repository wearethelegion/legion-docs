---
title: Özel Araçlar
description: LLM'un legion'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. legion'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.legion/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/legion/tools/` içine yerleştirerek.
