---
title: SDK
description: legion sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

legion JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
legion'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `legion.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir legion örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
