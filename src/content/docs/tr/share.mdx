---
title: Paylasim
description: legion konusmalarini genel baglantilarla paylasin.
---

legion'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda legion:
...
legion, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak legion manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `legion.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda legion kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
