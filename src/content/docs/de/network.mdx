...
Legion unterstützt Standard-Proxy-Umgebungsvariablen und benutzerdefinierte Zertifikate für Unternehmensnetzwerkumgebungen.

---

## Proxy

Legion respektiert Standard-Proxy-Umgebungsvariablen.
...
Wenn Ihr Unternehmen benutzerdefinierte Zertifizierungsstellen für HTTPS-Verbindungen verwendet, konfigurieren Sie Legion so, dass es ihnen vertraut.
