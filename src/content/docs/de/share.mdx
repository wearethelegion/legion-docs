---
title: Teilen
description: Teile Legion-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Legion-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Legion Folgendes:
...
Legion hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Legion den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`legion.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du legion in deiner Organisation einsetzt.
