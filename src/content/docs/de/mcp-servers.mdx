...
Sie können den MCP-Server in Ihrem [Legion Config](https://wearethelegion.com/docs/config/) unter `mcp` definieren. Fügen Sie jedem MCP einen eindeutigen Namen hinzu. Sie können bei der Eingabe von LLM namentlich auf diesen MCP verweisen.
