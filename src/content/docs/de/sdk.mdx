---
title: SDK
description: Typsicherer JS-Client fuer den legion-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das legion JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und legion programmatisch steuern.
...
`legion.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn legion bereits laeuft, kannst du nur einen Client erstellen und verbinden:
