...
يمكنك تعريف خوادم MCP في [إعدادات Legion](https://wearethelegion.com/docs/config/) ضمن `mcp`. أضف كل خادم MCP باسم فريد. ويمكنك الإشارة إلى ذلك الخادم بالاسم عند توجيه الطلب إلى الـ LLM.
