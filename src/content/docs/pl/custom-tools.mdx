...
Narzędzia stosowane do funkcji, z których LLM może korzystać podczas rozmów. Współpracują z [wbudowanymi narzędziami] (./tools) legion, wtyczka jak `read`, `write` i `bash`.
...
- Lokalnie, umieszczając je w katalogu `.legion/tools/` swojego projektu.
- Lub globalnie, umieszczając je w `~/.config/legion/tools/`.
