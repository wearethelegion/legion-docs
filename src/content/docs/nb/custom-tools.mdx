...
description: Lag verktøy som LLM kan kalle inn Legion.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Legion sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.legion/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/legion/tools/`.
