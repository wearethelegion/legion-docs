...
Du kan definere MCP-servere i [Legion Config](https://wearethelegion.com/docs/config/) under `mcp`. Legg til hver MCP med et unikt navn. Du kan referere til den MCP ved navn når du spør LLM-en.
