...
Agentferdigheter lar Legion oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går legion opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
legion viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `legion.json`:
